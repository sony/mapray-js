...
export class PrimitiveProducer extends Entity.PrimitiveProducer {
    ...
    constructor( entity: PolygonEntity )
    {
        ...
        // プリミティブ
        // @ts-ignore
        var primitive = new Primitive( entity.scene.glenv, null, entity._getMaterial( RenderTarget.SCENE ), this._transform );
        ...
        // @ts-ignore
        var pickPrimitive = new Primitive( entity.scene.glenv, null, entity._getMaterial( RenderTarget.RID ), this._transform );
...
export class FlakePrimitiveProducer extends Entity.FlakePrimitiveProducer {
    ...
    private _material_map: Map<RenderTarget, object>;
    ...
    constructor( entity: PolygonEntity ) {
        ...
        this._material_map = Object.entries(RenderTarget).reduce((map: Map<RenderTarget, object>, [ key, value ]: [ key: string, value: RenderTarget ]) => {
                // @ts-ignore
                map.set( value, entity._getMaterial( value ) );
                return map;
        }, new Map<RenderTarget, object>());
